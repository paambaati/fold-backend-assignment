...
export class CdkResourceInitializer extends Construct {
  ...
  constructor (scope: Stack | Construct, id: string, props: CdkResourceInitializerProps) {
    super(scope, id)
    ...
    // REFER: https://github.com/aws/aws-cdk/blob/cafe8257b777c2c6f6143553b147873d640c6745/packages/%40aws-cdk/custom-resources/lib/aws-custom-resource/aws-custom-resource.ts#L360
